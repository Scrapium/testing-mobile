...
for oauth_consumer_key, oauth_consumer_secret, name in keys_and_secrets:
    ...
    params = {
        'graphql': 'pAyVFRiMFMp9KCfffF7LHg/HomeLatestTimeline',
        'features': {
        ...
        'oauth_nonce': '5573291061171068319',
        'oauth_signature_method': 'HMAC-SHA1',
        'oauth_timestamp': '1687665592',
        'oauth_token': '6rQxgwAAAAAACIKFAAABiPC1YmE',
        'oauth_version': '1.0',
    }


    enc = auth.encode_params("https://api.twitter.com/graphql/pAyVFRiMFMp9KCfffF7LHg/HomeLatestTimeline", "GET", params)
    ...
    try:
        ...
        print(headers)
        print(data)
        response = requests.request("GET", parsed_query , headers=headers, data=payload)
        print(response)
